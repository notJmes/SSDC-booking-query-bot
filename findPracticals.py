...
def login(client, password, username):
    response = client.get('https://www.ssdcl.com.sg/User/Login')
    ...
    sel = get_html('https://www.ssdcl.com.sg/User/Login')
    ...
    response = client.post('https://www.ssdcl.com.sg/Account/Login', data=details, headers={'Referer': 'https://www.ssdcl.com.sg/User/Login'})
    print('User is logged in' if response.url == 'https://www.ssdcl.com.sg/User/Information' else f'Not logged in; currently in {response.url}')


def main_scanner(client,dict={}, filter='', pwd=''):
    for i in range(2):
        try:
            formdata = {'SlotId':'0',
            ...
            formdata_2 = {'SlotId':'0',
                        ...
                        'IsOrientation':'False',
                        'BookingType':'PL',
                        'SelectedLocation':'Ang Mo Kio'}

            verify = [0,0]
            response = client.post('https://www.ssdcl.com.sg/User/Booking/GetEarliestSlotDate',data=formdata)
            result_WL, verify[0] = getDate(response)
            response = client.post('https://www.ssdcl.com.sg/User/Booking/GetEarliestSlotDate',data=formdata_2)
            ...
            print('Woodlands'.ljust(10,' ')+' -', result_WL)

            print('Ang Mo Kio'.ljust(10,' ')+' -', result_AMK)
